package go.easy.skel.view.adapter.list
 ...
 * for easy_go_skel on 20.05.20 23:58.
 */
    ...
    try {
      ...
      layoutParams.bottomMargin = if (position < (itemCount - spanCount)) {
        ...
        if (lastItemBottomMargin == null) {
          lastItemBottomMargin = holder.itemView.context.resources.getDimensionPixelSize(lastItemBottomMarginDimenId)
        }
